      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 w-full py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {DataServices.services.map((service) => (
            <div className="group bg-white/10 backdrop-blur-sm p-6 rounded-lg shadow-md border border-white/20 transition-all duration-300 hover:scale-105 hover:bg-white/20">
